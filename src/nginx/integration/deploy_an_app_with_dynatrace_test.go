...
var _ = Describe("CF Nginx Buildpack", func() {
	...
	Context("deploying a nginx app with Dynatrace agent with single credentials service", func() {
	...
	Context("deploying a nginx app with Dynatrace agent with configured network zone", func() {
		It("checks if Dynatrace injection was successful", func() {
			serviceName := "dynatrace-" + cutlass.RandStringRunes(20) + "-service"
	...
	Context("deploying a nginx app with Dynatrace agent with two credentials services", func() {
	...
	Context("deploying a nginx app with Dynatrace agent with failing agent download and ignoring errors", func() {
	...
	Context("deploying a nginx app with Dynatrace agent with two dynatrace services", func() {
	...
	Context("deploying a nginx app with Dynatrace agent with single credentials service and without manifest.json", func() {
		It("checks if Dynatrace injection was successful", func() {
			serviceName := "dynatrace-" + cutlass.RandStringRunes(20) + "-service"
			command := exec.Command("cf", "cups", serviceName, "-p", fmt.Sprintf("'{\"apitoken\":\"secretpaastoken\",\"apiurl\":\"%s\",\"environmentid\":\"envid\"}'", dynatraceAPIURI))
			_, err := command.CombinedOutput()
	...
	Context("deploying a nginx app with Dynatrace agent with failing agent download and checking retry", func() {
	...
	Context("deploying a nginx app with Dynatrace agent with single credentials service and a redis service", func() {
		It("checks if Dynatrace injection was successful", func() {
			serviceName := "dynatrace-" + cutlass.RandStringRunes(20) + "-service"
			command := exec.Command("cf", "cups", serviceName, "-p", fmt.Sprintf("'{\"apitoken\":\"secretpaastoken\",\"apiurl\":\"%s\",\"environmentid\":\"envid\"}'", dynatraceAPIURI))
			_, err := command.CombinedOutput()
